...
const serviceCollection = client.db('cars-client').collection('services');
const bookingCollection = client.db('cars-client').collection('bookings'); 
        // jwt
